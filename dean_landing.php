...
if (!$dean || !isset($dean['name'])) {
    die("Dean details not found. Please contact the administrator.");
}
?>
...
<body>
    ...
    <div class="header">
        ...
        <h1>PTU Dean's Portal<br>Puducherry Technological University</h1>
    </div>

    <div class="sub-header">
        Warm Welcome to the Dean Portal !!!
    </div>
    ...
    <div class="main-container">
        <div class="profile-container">
            <div class="profile-card">
                ...
                <h3>Welcome, <?php echo htmlspecialchars($dean['name']); ?></h3>
                <p><strong>Reg No:</strong> <?php echo htmlspecialchars($dean['registration_number']); ?></p>
                <p><strong>Email:</strong> <?php echo htmlspecialchars($dean['email']); ?></p>
                <button class="edit-btn" onclick="window.location.href='editprofiledean.php'">Edit Profile</button>
            </div>
        </div>
